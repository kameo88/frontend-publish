<template>
  ...
  <el-form :model="ruleForm" :rules="rules" ref="ruleForm">
    ...
    <div class="tbl-wrap order">
      <div class="tbl-top">
        <h4 class="tbl-title price">상품요금 선택</h4>
      </div>
      <dl>
    ...
    <div class="tbl-wrap order">
      <div class="tbl-top">
        <h4 class="tbl-title goods">정보상품 선택</h4>
        <div class="right">
          <el-button @click="dialogHistoryVisible = true" type="primary" size="small" icon="iconset icon-time-white"
            >이전 이력보기 sample</el-button
          >
        </div>
      </div>
      <!-- 10/05 추가 ; 지연 시세 (지수) -->
    ...
    <!-- 해지신청 사유정보 -->
    <div class="title-wrap sub">
      <h3 class="title">해지신청 사유정보</h3>
    </div>
    <div class="info-box biz data">
      <dl>
        <dt class="label">해지사유</dt>
        <dd class="items">사용종료</dd>
      </dl>
      <dl>
        <dt class="label">해지사유내용</dt>
        <dd class="items">
          해지사유입력 에 들어간 텍스트 내용이 표시됩니다. 해지사유입력 에 들어간 텍스트 내용이 표시됩니다. 해지사유입력
          에 들어간 텍스트 내용이 표시됩니다.
        </dd>
      </dl>
      <dl>
        ...
        <dd class="items">
          <ul class="files-list">
            <li>
              <a href="#none" class="file-link" download>
                <span>첨부파일.pdf</span>
                <span class="iconset icon-down-attach">파일 다운로드</span>
              </a>
            </li>
            <li>
              <a href="#none" class="file-link" download>
                코드값모음집_20210614.xlsx
                <span class="iconset icon-down-attach">파일 다운로드</span>
              </a>
            </li>
          </ul>
  ...
  <div class="btn-area">
    ...
    <el-button type="primary">제출하기</el-button>
  </div>
  <div class="btn-area">
    <el-button class="gray">목록</el-button>
    <el-button class="gray">요약보기</el-button>
  </div>
  <div class="btn-area">
    <el-button class="gray">취소</el-button>
    <el-button class="gray">요약보기</el-button>
  ...
  <div class="btn-area">
    <el-button class="gray">목록</el-button>
    <el-button @click="dialogAllHistoryVisible = true" class="gray">변경 이력보기</el-button>
  </div>
  <!-- //button area -->

  <!-- 이전 이력보기 modal popup -->
  <el-dialog title="이전 이력보기" v-model="dialogHistoryVisible" custom-class="el-xx-large history">
    <div class="history-nav">
      <dl>
        <dt class="label">승인일자</dt>
        <dd class="nav">
          <el-button class="icon">
            <i class="iconset icon-prev-date">previous</i>
          </el-button>
          <span class="date">2021-10-10</span>
          <el-button class="icon" disabled>
            <i class="iconset icon-next-date">next</i>
          </el-button>
        </dd>
        <dt class="label">작성자</dt>
        <dd class="items">홍길동</dd>
        <dd class="num">
          <span class="current">1</span>
          <span class="total">20</span>건
        </dd>
      </dl>
    </div>
    <div class="history-wrap">
      <div class="history-order">
        <div class="tbl-wrap type2">
          <el-table :data="tableDataProduct1" :span-method="rowsapnMerge3" class="type2" style="width: 100%">
            <el-table-column label="정보상품명">
              <el-table-column prop="product1" label="Type1"></el-table-column>
              <el-table-column prop="product2" label="Type2"></el-table-column>
            </el-table-column>
            <el-table-column prop="market" label="대상시장" width="530"></el-table-column>
            <el-table-column label="사용여부" width="70">
              <template v-slot="scope"><el-checkbox v-model="scope.row.isEnabled"></el-checkbox></template>
            </el-table-column>
          </el-table>
          <div class="option">
            <el-form-item prop="productType1">
              <el-checkbox v-model="ruleForm.productType1">
                주식옵션/선물 기초자산 정보에 한하여 수신이용 하려는 경우. * 주문유형이 증권선물사의 경우에만 적용,
                증권A와 증권B일 경우에만 해당됩니다.
              </el-checkbox>
            </el-form-item>
          </div>
        </div>
  ...
  <!-- 변경 이력보기 modal popup -->
  <el-dialog title="변경 이력보기" v-model="dialogAllHistoryVisible" custom-class="el-extra-large history">
    <div class="history-nav">
      <dl>
        <dt class="label">승인일자</dt>
        <dd class="nav">
