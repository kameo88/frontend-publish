<template>
  <div class="signup-wrap">
    <div class="signup-box">
      ...
      <ol class="signup-step">
        <li class="active"><span class="step">1</span>약관동의</li>
        <li><span class="step">2</span>정보입력</li>
  ...
  <!-- //modal popup ; 개인정보처리방침 -->
  <!-- modal popup ; 개인정보 수집·이용 동의 -->
  <el-dialog title="수집·이용 동의서" v-model="dialogUseVisible" custom-class="el-medium">
